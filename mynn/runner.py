...
class RunnerM():
    ...
    def train(self, train_set, dev_set, **kwargs):
        ...
        for epoch in range(num_epochs):
            ...
            for iteration in range(int(X.shape[0] / self.batch_size)):
            ...
            trn_score, trn_loss = self.evaluate(train_set)
            ...
            if dev_score + tolerance > best_score:
                best_score = dev_score
                no_improve_epochs = 0
                save_path = os.path.join(save_dir, 'best_model.pickle')
                self.save_model(save_path)
                print(f"Best accuracy improved to {best_score:.5f}, saving model...")
            else:
                no_improve_epochs += 1
